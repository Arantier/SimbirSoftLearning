...
object DateUtils {
    ...
    fun eventDateIntervalRepresentation(context: Context, start: LocalDate, end: LocalDate): String {
        return context.getString(R.string.event_date_expiration_info,
                context.resources.getQuantityString(R.plurals.event_date_expiration, daysRest(end), daysRest(end)),
                dateToString(start),
                dateToString(end))
    }
